...
import { CLOSED_PLAN_STATUSES } from '../../../shared/plan-vocab.js';

/**
 * The terminal statuses — the same OBJECT the server reads, not a copy that
 * matches it today. `shared/plan-vocab.js` owns the words.
 */
