    ...
    <div className={cn('flex min-w-0 flex-col', className)}>
      ...
      {items.length === 0 ? (
        ...
        <div
          ...
          style={{ maxHeight }}
        >
          {/* `presentation` because ARIA requires a `listitem` to be OWNED by a
              `list`, and a virtualiser has to put a sized, positioned spacer
              between the two. Without this the rows' role is ignored and a
              screen reader loses "item 3 of 40" entirely — the standard escape
              hatch for exactly this wrapper. */}
