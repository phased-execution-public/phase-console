...
/**
 * The field class both pages were spelling out — now `fieldSurface`, from
 * `components/ui/field.ts`, which is where the console's one control class
 * lives.
 *
 * Kept as a named re-export rather than deleted: the two toolbars import it
 * from here by this name, and a control class is not a thing to rename in the
 * same change that unifies it.
 */
export const fieldClass = fieldSurface;
