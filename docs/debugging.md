...
| `outcome` | `runs/<instance>/<slug>/outcomes/phase-NN.json` | What an **unsupervised** session declared about how it ended. A file here that the console will not act on shows up as `outcome.unreadable`, which is worth knowing. |
