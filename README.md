...
| You want                         | Run                                                                                             | Notes                                                                                                     |
| -------------------------------- | ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| The **skill** in Claude Code     | `/plugin marketplace add phased-execution-public/phase-console` then `/plugin install phased-execution@phased-execution-public` | Auto-updates from every commit to `main`. Build its console once (`cd viewer && npm ci && npm run build`) |
| An editable tree                 | `git clone https://github.com/phased-execution-public/phase-console ~/.claude/skills/phased-execution`        | Skill + console from one folder you control                                                               |
