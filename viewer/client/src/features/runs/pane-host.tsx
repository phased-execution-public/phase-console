...
export interface LanePaneProps {
  ...
  subtitle?: string;
  /**
   * The pane's heading, when the default ("Phase N console") is ambiguous.
   *
   * The cross-plan strip on `#/runs` needs it: two panes reading "Phase 5
   * console" there are two different plans. A run page never passes it.
   */
  title?: string;
