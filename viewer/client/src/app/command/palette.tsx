...
export function Palette({
  ...
  // it within one release. The two guards that make either safe — a focused
  // field, and a focused pty, whose Ctrl-K is kill-to-end-of-line — belong to
  // every shortcut in the app and live in `lib/shortcut.ts`.
  ...
  useShortcut([{ key: 'k', mod: true, whileTyping: true }, { key: '/' }], toggle);
