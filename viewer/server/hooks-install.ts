 ...
 * four entries — SessionStart, SessionEnd, Stop, Notification — into that file and takes
...
export const HOOK_EVENTS = ['SessionStart', 'SessionEnd', 'Stop', 'Notification'] as const;
