 ...
 * worse than a line sitting near an edge — and `start` puts it at the top,
 * which is what a deep link to a whole section means.
 */
export function scrollIntoScroller(el: Element, block: 'center' | 'nearest' | 'start' = 'center'): void {
